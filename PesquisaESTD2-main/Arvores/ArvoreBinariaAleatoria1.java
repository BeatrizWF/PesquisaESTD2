...
public class ArvoreBinariaAleatoria1<T extends Comparable<T>> {
    class Elemento {
    ...
    public ArvoreBinariaAleatoria1(int ordem) {
        this.ordem = ordem;
        raiz = new Elemento();
    }
    ...
    */
    ...
    public static void vetorAleatorio(int n, int ordem) {
        ...
        ArvoreBinariaAleatoria1<Integer> a = new ArvoreBinariaAleatoria1<>(ordem);
