...
public class ArvoreBinariaOrdenada5<T extends Comparable<T>> {
    class Elemento {
    ...
    public ArvoreBinariaOrdenada5(int ordem) {
        this.ordem = ordem;
        raiz = new Elemento();
    }
    ...
    public static void vetorOrdenado(int n, int ordem) {
        ...
        ArvoreBinariaOrdenada5<Integer> a = new ArvoreBinariaOrdenada5<>(ordem);
