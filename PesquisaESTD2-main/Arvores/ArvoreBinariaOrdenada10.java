...
public class ArvoreBinariaOrdenada10<T extends Comparable<T>> {
    class Elemento {
    ...
    public ArvoreBinariaOrdenada10(int ordem) {
        this.ordem = ordem;
        raiz = new Elemento();
    }
    ...
    public static void vetorOrdenado(int n, int ordem) {
        ...
        ArvoreBinariaOrdenada10<Integer> a = new ArvoreBinariaOrdenada10<>(ordem);
