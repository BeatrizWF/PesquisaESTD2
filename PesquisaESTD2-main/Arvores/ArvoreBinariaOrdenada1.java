...
public class ArvoreBinariaOrdenada1<T extends Comparable<T>> {
    class Elemento {
    ...
    public ArvoreBinariaOrdenada1(int ordem) {
        this.ordem = ordem;
        raiz = new Elemento();
    }
...
*/
    ...
    public static void vetorOrdenado(int n, int ordem) {
        ...
        ArvoreBinariaOrdenada1<Integer> a = new ArvoreBinariaOrdenada1<>(ordem);
