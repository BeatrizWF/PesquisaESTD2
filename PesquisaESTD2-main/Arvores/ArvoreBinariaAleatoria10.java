...
public class ArvoreBinariaAleatoria10<T extends Comparable<T>> {
    class Elemento {
    ...
    public ArvoreBinariaAleatoria10(int ordem) {
        this.ordem = ordem;
        raiz = new Elemento();
    }
...
*/
    ...
    public static void vetorAleatorio(int n, int ordem) {
        ...
        ArvoreBinariaAleatoria10<Integer> a = new ArvoreBinariaAleatoria10<>(ordem);
